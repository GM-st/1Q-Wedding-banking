		...
		<section class="min-vh-70 d-flex align-items-center">
			<div class="container py-5">
				...
				<div
					...
					<div class="col-12 col-sm-9 col-md-8 col-lg-5 mb-5 mb-lg-0">
						<img class="img-fluid" src="img_2/illustrations/maintenance.svg"
																	...
																	<div class="card card-sm card-body border-light">
																		...
																		<div class="collapse" id="panel-6">
																			<div class="pt-3">
																				...
																				<ul id=groupSection
																					class="list-group list-group-flush rounded border border-light">
