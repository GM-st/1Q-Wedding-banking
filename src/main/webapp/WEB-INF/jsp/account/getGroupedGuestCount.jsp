...
<!--,하이차트  -->
	...
	fetch("member/getGroupedGuestCount")
	.then(res=>res.json())
	.then(res=>{
		...
		for(let i=0 ;i<transactionList.length;i++){
			...
			let groupedGuestCountList = [];
			
			groupedGuestCountList.push(transactionList[i].GUEST_GROUP);
			groupedGuestCountList.push(transactionList[i].COUNT);
			
			finalGroupedGuestCountList.push(groupedGuestCountList);
